...
export interface ApiCategoriaCategoria extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    posicion: Schema.Attribute.UID<''> & Schema.Attribute.Required;
    preview: Schema.Attribute.Blocks & Schema.Attribute.Required;
    productos_breve: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiEmpresaEmpresa extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    emailPrincipal: Schema.Attribute.Email & Schema.Attribute.Required;
    emailSecundario: Schema.Attribute.Email;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::empresa.empresa'
    ...
    telefonoPrincipalNoSpaces: Schema.Attribute.String &
      Schema.Attribute.Required;
    telefonoSecundarioNoSpaces: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMarcaMarca extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    catalogo: Schema.Attribute.Media<'images' | 'files' | 'videos', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descripcion: Schema.Attribute.Blocks;
    destacado: Schema.Attribute.Boolean;
    imagenesDeProductos: Schema.Attribute.Media<'images' | 'files', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiSubcategoriaSubcategoria
  ...
  attributes: {
    caracteristicas: Schema.Attribute.Component<'shared.list', true>;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descripcion: Schema.Attribute.Text;
    descripcionExtra: Schema.Attribute.Text;
    destacado: Schema.Attribute.Boolean;
    imagen: Schema.Attribute.Media<'images' | 'files'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    > &
      Schema.Attribute.Private;
    nombre: Schema.Attribute.String & Schema.Attribute.Required;
    preguntas: Schema.Attribute.Component<'shared.object', true>;
    preview: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'nombre'> & Schema.Attribute.Required;
    tipos: Schema.Attribute.Component<'shared.list', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
